...
protocol CountriesDBRepository {
    func hasLoadCategories() -> AnyPublisher<Bool, Error>
    
    func store(countries: [Kitty_Category]) -> AnyPublisher<Void, Error>
    func categories(search: String, locale: Locale) -> AnyPublisher<LazyList<Kitty_Category>, Error>
...
extension Kitty_Category {
    
    static func justOneCountry() -> NSFetchRequest<Kitty_Category> {
